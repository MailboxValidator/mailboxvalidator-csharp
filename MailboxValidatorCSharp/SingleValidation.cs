...
namespace MailboxValidator
{
    public class SingleValidation
    {
        ...
        public MBVResult DisposableEmail(String email)
        {
            ...
            request = (HttpWebRequest)WebRequest.Create("http://api.mailboxvalidator.com/v1/email/disposable?" + datastr.TrimStart("&".ToCharArray()));
